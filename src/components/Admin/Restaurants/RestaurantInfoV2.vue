...
<template>
    <div class="cursor-pointer hover:bg-gray-200/80 shadow-[0_0_8px_rgba(0,0,0,0.1)] items-center mb-4 p-3 grid grid-cols-[minmax(0,17rem)_minmax(0,17rem)_minmax(15rem,1fr)_auto] rounded-2xl">
