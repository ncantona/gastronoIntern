...
<template>
    <div class="flex flex-col">
        <div class="self-center w-95/100 bg-white/80 shadow-2xl border-main-500 p-3 rounded-lg flex m-5 min-h-[550px] h-[600px] overflow-y-hidden hover:overflow-y-auto">
