    ...
    <div>
        ...
        <aside
            ...
            <nav class="p-4 space-y-4 text-lg flex flex-col gap-2">
                <RouterLink :to="{ name: 'dashboardbar' }" @click="toggleSidebar" class="hover:text-[rgb(84,63,20)] cursor-pointer text-white">Übersicht</RouterLink>
                <a class="block hover:text-[rgb(84,63,20)] cursor-pointer text-white">Getränkeverwaltung</a>
