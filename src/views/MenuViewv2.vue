...
import Beer from '@/components/Svgs/Beer.vue';
    ...
    <Window class="flex flex-col p-12 gap-5 min-h-175">
        <div class="flex justify-between">
            <div class="flex flex-col gap-2 mb-5">
                <span class="text-2xl font-semibold">Meine Speisekarte</span>
        ...
        <div class="mb-2.5 flex flex-col gap-5">
            <div class="flex lg:flex-row flex-col gap-2 justify-between lg:items-center">
                ...
                <CustomButton variant="editBlue" @click="showAddCategory = true" class="gap-2">
